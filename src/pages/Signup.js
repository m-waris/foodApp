...
export default function Signup() {
  ...
  const [values, setValues] = useState({ name: "", location: "", email: "", password: "" });
  ...
  return (
    <>
      <section className="h-auto bg-slate-300">
          ...
          <div className=" mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            <form onSubmit={handelSubmit}>
              <div className="relative mb-6">
                <input
                  type="text"
                  className="block min-h-[auto] w-auto lg:w-5/6  rounded border border-stone-500 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none"
